...
//                Util::dd($data);
                ...
                $address_supplier_id = $this->database->insert("supplier_addresses",$data_to_be_inserted);
...
//        Util::dd($result);
    ...
    {
        $validationData['first_name'] = $data['supplier_first_name'];
       $validationData['last_name'] = $data['supplier_last_name'];
       $validationData['gst_no'] = $data['supplier_gst_no'];
       $validationData['phone_no'] = $data['supplier_phone_no'];
       $validationData['email_id'] = $data['supplier_email_id'];
    ...
    //Util::dd($validationData);
        ...
        if(!$validation->fails())
        {
            try{
                ...
                $filteredData['first_name'] = $data['supplier_first_name'];
                $filteredData['last_name'] = $data['supplier_last_name'];
                $filteredData['gst_no'] = $data['supplier_gst_no'];
                $filteredData['phone_no'] = $data['supplier_phone_no'];
                $filteredData['email_id'] = $data['supplier_email_id'];
